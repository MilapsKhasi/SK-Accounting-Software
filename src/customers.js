  ...
  container.innerHTML = `
    <div class="p-8 space-y-8">
      <header class="flex justify-between items-end">
        ...
        <button id="new-customer-btn" class="flex items-center gap-2 px-4 py-2 bg-[#1e2a38] text-white hover:bg-[#2c3e50] transition-colors text-xs font-bold uppercase tracking-widest">
  ...
  modal.innerHTML = `
    <div class="bg-white w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-gray-100">
      <div class="p-6 border-b border-gray-100 flex justify-between items-center sticky top-0 bg-white z-10">
        <h2 class="text-xl font-bold text-gray-900 uppercase tracking-tight">${isEditing ? 'Edit' : 'Add'} Customer</h2>
      ...
      <form id="customer-form" class="p-8 space-y-6">
        ...
        <div class="flex justify-end gap-3 pt-4">
          ...
          <button type="submit" class="px-8 py-2.5 bg-[#1e2a38] text-white text-xs font-bold hover:bg-[#2c3e50] transition-all uppercase tracking-widest">Save Customer</button>
        </div>
      </form>
    </div>
  `;
